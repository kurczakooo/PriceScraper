...
async def main_fuction(SYSTEM_PATH, chromedriver_options, user_agent_string_override, url, data_file_path, url_type=None):
    ...
    await notify_about_the_price(current_price)
...
if __name__ == "__main__":
    ...
    asyncio.run(main_fuction(PATH, chrome_options, user_agent_string_override_command, xiaomi_g34wqi_ceneo_url, xiaomi_prices_file))